...
const HeroSection = () => {
  ...
  if (!hero) return <div>Hero data not found.</div>;
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 left-10 w-72 h-72 rounded-full bg-primary-light opacity-10 blur-3xl" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-primary text-white font-semibold text-base hover:brightness-110 transition shadow-lg"
              >
          ...
          <div className="hidden lg:flex justify-center">
            <div className="relative">
              ...
              {/* Floating Icon */}
              <div className="absolute -bottom-4 -right-4 w-24 h-24 rounded-2xl bg-gradient-to-r from-primary to-primary-dark flex items-center justify-center shadow-lg">
